...
module.exports = Monitor = function (server, settings, logger) {
    ...
    this.timer = null;
    this.server = server;
    this.options = Utils.clone(settings) || {};
    ...
    if (typeof this.options.monitor.ops !== "undefined" &&
        ...
        if (this.options.monitor.interval &&
            ...
            this.ops_interval = setInterval((function(){
                ...
                self.processOps(function (err, results) {
...
Monitor.prototype._request = function (client, url) {
    ...
    return function (request) {
        ...
        var data = {
            ...
            appVer: self.package.version || "0.0.1",
            events: [
                {
                    event: 'request',
...
Monitor.prototype._ops = function(client, url) {
    ...
    return function(results) {
        ...
        var module = self.options.module || 'Blammo';
        var data = {
            module: module,
            appVer: self.package.version || "0.0.1",
            host: require('os').hostname(),
            ...
            for (var i in hosts) {
                ...
                if (hosts.hasOwnProperty(i)) {
                    ...
                    if (self.options.monitor[event][host]) {
                        ...
                        self.options.monitor[event][host](client, self)(request);
                    }
                    else {

                        try {

                            self['_' + event](client, host, self)(request);
                        }
                        catch (e) {
