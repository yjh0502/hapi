...
exports.query = function (request, next) {
    ...
    Joi.validate(request.query, request._route.config.validate.query,
...
exports.payload = function (request, next) {
    ...
    Joi.validate(request.payload, request._route.config.validate.schema,
        {convert: true},  function (err) {
...
exports.path = function (request, next) {
    ...
    Joi.validate(request.params, request._route.config.validate.path,
        {convert: true},  function (err) {
...
exports.response = function (request, next) {
    ...
    Joi.validate(request._response._raw, request._route.config.response.schema,
        {convert: true},  function (err) {
